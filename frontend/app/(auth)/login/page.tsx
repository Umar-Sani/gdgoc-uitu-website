...
function LoginForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const role = profileJson.data?.role_name || data.user?.user_metadata?.role || 'user';
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
        ...
        <div className="px-8 py-10">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-6 py-2.5 rounded-xl border border-gray-200 bg-white hover:bg-gray-50 hover:border-gray-300 transition-all shadow-sm text-sm font-medium text-gray-700"
          >
